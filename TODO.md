...
- ⏸️ Phase 2 采纳率/留存率（需 IDE 插件 + Git 分析）
### 更多应用适配
...
| 5 | ROADMAP Phase 1 已落地（v2.3.0 规划） | 对话轮次/Token估算/按模型·项目拆分/会话详情面板/报告章节 ☆ 见 [docs/ROADMAP.md](docs/ROADMAP.md)；Phase 3 成本与 ROI、Phase 4 行为洞察（死循环/专注度/人格）已落地；Phase 2 质量分析仍未做 |
